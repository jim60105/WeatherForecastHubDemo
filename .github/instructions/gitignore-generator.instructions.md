...
1. Ask user to provide one of the following `.gitignore` templates id:
...
2. Then, you can use the following command to generate a .gitignore file for your project:
